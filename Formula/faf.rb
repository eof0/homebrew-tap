class Faf < Formula
  ...
  url "https://github.com/eof0/faf/releases/download/v3.0.0/faf-macos-arm64-v3.0.0.tar.gz"
  ...
  on_linux do
    on_intel do
      url "https://github.com/eof0/faf/releases/download/v3.0.0/faf-linux-x86_64-v3.0.0.tar.gz"
      sha256 "0179554cdcc2badb24c60c3d69d799d2a03a7cf73a8fd8b4c893acc2257f242c"
    end

    on_arm do
      url "https://github.com/eof0/faf/releases/download/v3.0.0/faf-linux-arm64-v3.0.0.tar.gz"
